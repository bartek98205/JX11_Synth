...
{
    m_voice.m_note = note;
    m_voice.m_osc.m_amplitude = (velocity / 127.0f) * 0.5f;
    m_voice.m_osc.m_freq = 261.63f;
    m_voice.m_osc.m_sampleRate = m_sampleRate;
    m_voice.m_osc.m_phaseOffset = 0.0f;
    m_voice.m_osc.reset();
